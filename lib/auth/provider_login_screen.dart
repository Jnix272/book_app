// screens/auth/provider_login_screen.dart
...
class ProviderSignInScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ProviderSignInScreen> createState() =>
      _ProviderSignInScreenState();
}

class _ProviderSignInScreenState extends ConsumerState<ProviderSignInScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<SignInState>(signInProvider, (prev, next) {
      if (next is SignInSuccess) {
        _toast(context, 'Welcome back! Signing you in…');
      }
    });
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Center(
                  child: GestureDetector(
                    onTap: () => context.push('/provider_signup'),
                    child: RichText(
                      text: TextSpan(
                        style: GoogleFonts.dmSans(
                          fontSize: 14,
